...
public class TestHelloWorld {
	...
	public void test() {
		...
		Object result = session.selectOne("com.atguigu.mybatis.mapper.EmployeeMapper.selectEmployeeById", 1);
	...
	//接口式编程
		...
		public void testMapper() {
			...
			try {
				...
				//创建接口的实现类
				EmployeeMapper mapper = session.getMapper(EmployeeMapper.class); //com.sun.proxy.$Proxy5
